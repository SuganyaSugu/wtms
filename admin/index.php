                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome to WTMS!</h1>
                                    </div>
                                    <form class="user" action="login.php"  method="post">
                                        <div class="form-group">
                                            <input type="email" tabindex="1" autofocus name="email" required class="form-control form-control-user"
                                        ...
                                        <button name="submit" id="submit" type="submit" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                    </form>
                                    <hr>
